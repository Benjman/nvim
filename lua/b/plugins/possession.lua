return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>Su', require('nvim-possession').update, { silent = true, desc = '[S]ession: [U]pdate' })
    vim.keymap.set('n', '<leader>Sd', require('nvim-possession').delete, { silent = true, desc = '[S]ession: [D]elete' })
  end,
  dependencies = {
    'ibhagwan/fzf-lua',
  },
